									...
									do {
										try {
											...
											case 12:
												...
												try {
													List<UserDetails> users = service1.showUsers();
													for (UserDetails Bean : users) {	
														if (Bean != null) {
															...
															System.out.println("Mobile_No is-->"+Bean.getMobileNumber());
											...
											case 2:
												...
												try {
													if(loginInfo.getuId()==user_Id) {
														List<BooksBorrowed> borrowedBookList = service1.bookBorrowed(user_Id);
